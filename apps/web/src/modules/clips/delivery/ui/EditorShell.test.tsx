...
const clip = { id: 'clip-1', title: 'Opening', startMs: 1000, endMs: 5000, sourceDurationMs: 10000, state: 'READY' };
...
describe('EditorShell', () => {
  it('wires selection, trim, add and render actions', async () => {
    ...
    render(<EditorShell clips={[clip]} onSelect={vi.fn()} onAddClip={onAddClip} onTrimChange={onTrimChange} onRenderSelected={onRenderSelected} onRenderAll={vi.fn()} />);
