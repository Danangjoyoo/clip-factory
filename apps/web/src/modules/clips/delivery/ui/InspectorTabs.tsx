...
export function InspectorTabs({
  children,
}: Readonly<{ children: Partial<Record<InspectorTab, ReactNode>> }>) {
  ...
  return (
    <section>
      <div role="tablist" aria-label="Clip inspectors" onKeyDown={move}>
        {tabs.map((tab) => (
          <button
            key={tab}
            role="tab"
      ...
      <div role="tabpanel" aria-label={`${active} inspector`}>
