...
def valid_probe(**changes: object) -> MediaProbe:
    values: dict[str, object] = dict(
        duration_ms=1000, size_bytes=100, container="mp4", video_codec="h264",
        width=1, height=1, frame_rate_numerator=30, frame_rate_denominator=1,
        audio_codec="aac", sample_rate_hz=16000,
    )
